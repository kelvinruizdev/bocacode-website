...
const UpcomingDates = ({ data }) => {
  ...
  return (<>
    ...
    <div className="py-50">
      ...
      <div className="py-50">
        <table className="maxwidth-1366 m-auto box-shadow-v1">
          <tr className="border-v2">
            {data?.fields &&
              data?.fields.map(field =>
                <td className=" text-center p-16 fs-14 fw-400 lh-20">{field}</td>
              )}
          </tr>
          <tr>
            {data?.date_info &&
